<template>
  <button
    ...
    >
      <!-- <svg version='1.1' class="sc-user-input--send-icon" xmlns='http://www.w3.org/2000/svg' x='0px' y='0px' width='37.393px' height='37.393px' viewBox='0 0 37.393 37.393' enableBackground='new 0 0 37.393 37.393'>
        <g id='Layer_2'>
      ...
      <!-- <v-icon>fal fa-paper-plane</v-icon> -->
    </button>
</template>

<template>
	<div style="position: relative">
		<button class="sc-user-input--file-icon-wrapper" type='button'>
		  <!-- <svg version="1.1" xmlns="http://www.w3.org/2000/svg" class="sc-user-input--file-icon" x='0px' y='0px' width='24px' height='24px' viewBox='0 0 37.393 37.393' enableBackground='new 0 0 37.393 37.393'>
    ...
    <!-- Отключаем возможность загрузки файла -->
